...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
	...
	def seedGen(self):
		...
		for key in self.keys:
			...
			these_seeds.append(seed)
		these_seeds[0] = these_seeds[0] + these_seeds[1][1:] + these_seeds[2][1:]
		these_seeds[1] = these_seeds[1] + these_seeds[0][1:] + these_seeds[2][1:]
		these_seeds[2] = these_seeds[2] + these_seeds[0][1:] + these_seeds[1][1:]

		for this_seed in these_seeds:
